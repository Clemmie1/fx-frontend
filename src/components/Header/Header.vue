...
<template>
  ...
  <nav class="bg-white border-b border-gray-200 px-4 py-2.5 dark:dark:bg-fx-sidebar dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
    ...
    <div class="flex flex-wrap justify-between items-center">
      <div class="flex justify-start items-center">
        ...
        <a class="flex items-center justify-between mr-4">
          <svg width="37" height="27" viewBox="0 0 57 47" fill="none" xmlns="http://www.w3.org/2000/svg">
