...
<template>
  ...
  >
    <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:dark:bg-fx-sidebar">
      <ul class="space-y-2">
        <li>
          <router-link to="/playground" >
            <a
                href="#"
                class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-zinc-800 dark:hover:bg-zinc-800 group"
            >
        ...
        <li>
          <router-link to="/keys">
            ...
            >
              ...
              <span class="ml-3">API-ключи</span>
            </a>
          </router-link>
        </li>
        <li>
          <button
              type="button"
              class="flex items-center p-2 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-zinc-800 dark:text-white dark:hover:bg-zinc-800"
          ...
          <ul id="dropdown-pages" class="hidden py-2 space-y-2">
            ...
            <li>
              <router-link to="/settings/limits" >
                <a
      ...
      >
        <li>
          <a
              href="#"
              class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-fx-main dark:text-white group"
          >
            <svg
                aria-hidden="true"
                class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-white group-hover:text-gray-900 dark:group-hover:text-white"
                fill="currentColor"
                viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg"
            >
