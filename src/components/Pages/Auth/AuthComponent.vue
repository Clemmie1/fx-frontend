...
onMounted(async () => {
  ...
  if (token) {
    ...
    router.push({ name: 'PlaygroundHome' });
  }
});
</script>
          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form class="space-y-4 md:space-y-6" @submit.prevent="handleLogin">
              ...
              <button
                  ...
                  class="font-bold w-full text-white rounded-lg text-sm px-5 py-2.5 text-center dark:bg-fx-main">
              ...
              <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                ...
                <router-link :to="{ name: 'RegisterPage' }"><a class="font-medium text-gray-500 hover:underline">Зарегистрироваться</a></router-link>
              </p>
