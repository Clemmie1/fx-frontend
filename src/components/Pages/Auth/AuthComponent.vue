...
<template>
  ...
  <div class="flex flex-col min-h-screen bg-white dark:bg-gray-900">
    <main class="bg-gray-50 dark:bg-fx-main">
...
<!--                У вас еще нет учетной записи? <router-link to="/register"><a href="#" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Зарегистрироваться</a></router-link>-->
<!--              </p>-->
